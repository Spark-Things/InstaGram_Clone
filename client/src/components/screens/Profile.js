...
const Profile = () => {
  ...
  return (
    <div className="mainDiv">
      <div className="profilePage" style={{ fontFamily: "Signika Negative"}}>
        ...
        <div style={{"width":"100%",
          ...
          <span style={{ fontWeight: "500", 
                         fontSize: "20px",
                         minWidth: "47%" }}>{state ? state.name : "Loading.."}
          ...
          <button style={{"padding": "5px 10px",
                   ...
                   onClick={()=>alert("tapa tatti")}       
                          ><img src={settingImage} style={{width:"20px",height:"20px"}}></img></button>
          </div>
          ...
          >
            ...
            <div>
              ...
              >
               <span style={{fontWeight:"650"}}>{state ? state.followers.length : "0"}</span>
              </span>
            ...
            <div>
              ...
              >
                <span style={{fontWeight:"650"}}>{state ? state.following.length : "0"}</span>
              </span>
          ...
          .map((item) => {
            ...
            <div className="item">
              <div className="itemDetailContainer"
               style={{"display":"flex"}}
              >
               <img src={likes} style={{"width":"22px","height":"22px","marginRight":"5px"}}/>
                       <span className="LikesCount"><b>{item.likes.length}</b></span>
                <img src={comments} style={{"width":"18px","height":"18px","marginRight":"5px"}}/>
                      <span className="CommentsCount"><b>{item.comments.length}</b></span>
                </div>
              <img
                key={item._id}
                src={item.photo}
