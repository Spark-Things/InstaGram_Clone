    ...
    <>
            <div className='PostDetailContainer'>
              ...
              <div className='PostContainer'> 
                  <img src={postData.photo} alt="loading img.." className='postImage'/>
              </div>
              ...
              <div className='detailContainer'>
                 ...
                 <div className='postbody'>
                     ...
                     { postData.postedBy ? 
                     <img src={postData.postedBy.pic} alt=''style={{"width":"35px","height":"35px","borderRadius":"50%"}} ></img>  : <span>Loading..</span> }
                     { postData.postedBy ? 
